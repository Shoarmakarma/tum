...
import shoarmakarma.theuselessmod.objects.blocks.item.ItemBlockVariants;
import shoarmakarma.theuselessmod.util.handlers.EnumHandler;
import shoarmakarma.theuselessmod.util.interfaces.IHasModel;
import shoarmakarma.theuselessmod.util.interfaces.IMetaName;
...
public class BlockOres extends Block implements IHasModel, IMetaName {
	...
	public BlockOres(String name, String dimension) {
		...
		setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.EnumType.EPIDOTE));
